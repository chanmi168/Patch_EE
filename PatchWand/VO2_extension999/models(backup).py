...
class cardioresp_multiverse(nn.Module):
    ...
    def forward(self, ecg, scg, ppg, feature):
        ...
        # concat multi-modal data (time domain)
        ...
        # get FFT of the time domain features
        ...
        features_fft_HR_ECG = features_fft_HR_ECG.reshape(features_fft_HR_ECG.size(0),-1)
        features_fft_HR_SCG = features_fft_HR_SCG.reshape(features_fft_HR_SCG.size(0),-1)
        features_fft_RR_PPG = features_fft_RR_PPG.reshape(features_fft_RR_PPG.size(0),-1)
        features_fft_RR_SCG = features_fft_RR_SCG.reshape(features_fft_RR_SCG.size(0),-1)
