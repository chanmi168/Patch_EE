...
from VO2_extension222.dataset_util import *
from VO2_extension222.models import *
import copy
...
#             total_losses_train[loss_name][epoch] = performance_dict_train['total_losses'][loss_name]
    ...
    if training_params['regressor_type']=='CardioRespXGBRegression':
        ...
        all_feature_train = np.concatenate([performance_dict_train['concat_feature_arr'], performance_dict_train['feature_arr']], axis=-1)
        all_feature_val = np.concatenate([performance_dict_val['concat_feature_arr'], performance_dict_val['feature_arr']], axis=-1)
...
def get_regression_names(training_params):
    ...
    # regression_names = ['ECG-HR_patch', 'SCG-HR_patch', 'PPG-RR_cosmed', 'SCG-RR_cosmed', 'VO2_cosmed']
    # regression_names = ['ECG-HR_patch', 'SCG-HR_patch', 'merged-HR_patch', 'PPG-RR_cosmed', 'SCG-RR_cosmed','merged-RR_cosmed', 'cardiac-VO2_cosmed', 'resp-VO2_cosmed', 'VO2_cosmed']
    regression_names = ['ECG-HR_patch', 'SCG-HR_patch', 'merged-HR_patch', 'PPG-RR_cosmed', 'SCG-RR_cosmed','merged-RR_cosmed', 'VO2_cosmed']
    # regression_names = ['ECG-HR_patch', 'SCG-HR_patch', 'merged-HR_patch', 'ECG-RR_cosmed', 'SCG-RR_cosmed','merged-RR_cosmed', 'cardiac-VO2_cosmed', 'resp-VO2_cosmed', 'VO2_cosmed']
    # regression_names = ['merged-HR_patch', 'merged-RR_cosmed', 'cardiac-VO2_cosmed', 'resp-VO2_cosmed', 'VO2_cosmed']
    # regression_names = ['merged-HR_patch', 'merged-RR_cosmed', 'VO2_cosmed']
#     regression_names = []
#     main_task_name = training_params['output_names'][0]
    
#     for auxillary_task in training_params['auxillary_tasks']:
#         for input_name in training_params['input_names']:
#             regression_names.append(auxillary_task+'-{}'.format(input_name))

#     for main_task in training_params['main_task']:
#         regression_names.append(main_task+'-'+training_params['output_sig_name'])

#         # for input_name in training_params['input_names']:
#         #     if 'scg' in input_name:
#         #         regression_names.append(main_task+'-{}'.format(input_name))
