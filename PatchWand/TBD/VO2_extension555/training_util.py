...
#             total_losses_train[loss_name][epoch] = performance_dict_train['total_losses'][loss_name]
    ...
    if training_params['regressor_type']=='CardioRespXGBRegression':
        ...
        all_feature_train = np.concatenate([performance_dict_train['concat_feature_arr'], performance_dict_train['feature_arr'][:, 3:]], axis=-1)
        all_feature_val = np.concatenate([performance_dict_val['concat_feature_arr'], performance_dict_val['feature_arr'][:, 3:]], axis=-1)
