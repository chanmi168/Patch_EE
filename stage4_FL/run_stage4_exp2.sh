...
echo "===================================== running stage 4 [HR estimate training_params_FFTregressor]  ====================================="
training_params_file="training_params_FFTRegression.json"
...
echo "===================================== running stage 4 [HR estimate training_params_RespiratoryRegression]  ====================================="
...
training_params_file="training_params_baseline67.json"
